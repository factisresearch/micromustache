 ...
 */
export declare function render(template: string, scope?: Scope, options?: ICompileOptions): string;
/**
 ...
 */
export declare function renderFn(template: string, resolveFn: ResolveFn, scope?: Scope, options?: ICompileOptions): string;
/**
 ...
 */
export declare function renderFnAsync(template: string, resolveFnAsync: ResolveFnAsync, scope?: Scope, options?: ICompileOptions): Promise<string>;
